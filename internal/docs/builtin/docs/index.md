...
- [Manage Global Access](how-to/manage-global-access.md) - retired, kept as a record
- [Manage Access Lists](how-to/manage-access-lists.md) - retired, kept as a record
